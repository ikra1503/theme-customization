<div class="products-block">
    <div class="wrap">
        <div class="section-title">
            <h4 class="title-line">New Arrrivals</h4>
                    ...
                    while ($products->have_posts()):
                        ...
                        $reviews = get_comments(
                            array(
                                ...
                                'type' => 'review', // Only reviews
                                'meta_query' => array(
                                    'relation' => 'AND', // Combine multiple conditions
                                    array(
                                        'key' => 'rating', // Meta key for rating
                                        'value' => array(3, 4.5), // Range of ratings
                                        'type' => 'DECIMAL',
                                        'compare' => 'BETWEEN', // Check if the rating is between the specified range
                                    ),
                                ),
                            )
                        );
                        $number_of_reviews_in_range = count($reviews);
                        ...
                        <div class="swiper-slide swiper-slide-active" style="width: 277.5px; margin-right: 20px;">
                            ...
                            <div class="<?php echo $out_of_stock_class; ?>" style="height: auto;"
                                ...
                                <p class="no-of-sale">
                                    <?php if ($number_of_reviews_in_range != 0): ?>
                                        <?php echo $number_of_reviews_in_range; ?> Reviews in range of 3-4.5
                                    <?php endif; ?>
                                </p>
                            </div>
