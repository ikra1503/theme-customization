	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-Mrp">
					<?php esc_html_e('Mrp', 'woocommerce'); ?>
				</th>
				...
				<th class="product-saved">
					<?php esc_html_e('YouSave', 'woocommerce'); ?>
				</th>
			...
			foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
				...
				if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
					...
					<tr
						...
						?>
						<td class="product-mrp" data-title="<?php esc_attr_e('Mrp', 'woocommerce'); ?>">
						...
						if ($product->is_on_sale()) {
							...
							// Calculate and display the saved amount
							$saved_amount = $regular_price - $sale_price;

							if ($cart_item['quantity'] != '0') {
								$save_amount = $saved_amount * $cart_item['quantity'];
							} else {
								$save_amount = $saved_amount;
							}
						}
						?>
						<td class="product-save" data-title="<?php esc_attr_e('YouSave', 'woocommerce'); ?>">

							<?php
							echo wc_price($save_amount);
							?>
						</td>
