...
$(document).ready(function () {
    ...
    function checkQuantity(productId) {
        var qtyBox = $('.qty[data-product-id="' + productId + '"]').closest('.qty-box');
        var btnGroup = $('.qty[data-product-id="' + productId + '"]').closest('.qty-box').siblings('.btn-group');
    ...
    $(document).on('click', '.add-to-cart', function (e) {
        ...
        if (quantity == 0) {
            ...
            showPopupNotification('You have to add more then zero quantity.');
    ...
    function add_cart(productId, variationIdColor, variationIdSize, quantity) {
        ...
        $.ajax({
            ...
            complete: function () {
                // Call checkQuantity() function after AJAX request is completed
