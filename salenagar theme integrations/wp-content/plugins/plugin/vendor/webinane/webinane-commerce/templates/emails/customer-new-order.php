...
<div style="text-align: center;">
	<a href="{{customer_account_url}}" target="_blank" class="wpcm-primary-btn" style="color:#FFFFFF; text-decoration:none;"><?php printf(esc_html__('VIEW %s', 'lifeline-donation-pro'), $orders_label ); ?></a>
</div>
