                                    ...
                                    <div class="wpcm-hover-btn">
                                        ...
                                        <?php else : ?>
                                            <lifeline-donation-button :id="<?php the_ID() ?>">
                                                <a href="#" class="donation-modal-box-callerrrr wpcm-btn wpcm-btn-icon wpcm-btn-green2"><span><i class="flaticon-hand"></i></span><?php echo esc_html($button_label) ? $button_label : esc_html_e('Donate Now', 'lifeline-donation-pro'); ?></a>
