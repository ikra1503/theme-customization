...
class Parallax5 extends Shortcodes
{
	static function init() {
		self::$shortcode = 'wi_donation_parallax5';
		self::$vc_map = self::vc_map();
		parent::init();
		add_filter('vc_autocomplete_wi_donation_parallax5_post_id_callback', array(__CLASS__, 'field_search'), 10, 3);
		add_filter('vc_autocomplete_wi_donation_parallax5_post_id_callback', array(__CLASS__, 'field_search'), 10, 3);
	}

	static function vc_map() {
		return [
			"name" => esc_html__("Parallax Style 5", 'lifeline-donation-pro'),
            "base" => self::$shortcode,
            ...
            "params" => array(
    			...
    			array(
    				'type'          => 'attach_image',
    				'class'         => '',
    				'heading'       => esc_html__( 'Background Image', 'lifeline-donation-pro' ),
    				'param_name'    => 'bg_image',
    				'description'   => esc_html__( 'Upload background to show.', 'lifeline-donation-pro' ),
    			),
                array(
                    "type" => "textfield",
                    "class" => "",
