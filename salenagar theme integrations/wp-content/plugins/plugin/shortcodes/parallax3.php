...
class Parallax3 extends Shortcodes
{
	static function init() {
		self::$shortcode = 'wi_donation_parallax3';
		self::$vc_map = self::vc_map();
		parent::init();
		add_filter('vc_autocomplete_wi_donation_parallax3_post_id_callback', array(__CLASS__, 'field_search'), 10, 3);
		add_filter('vc_autocomplete_wi_donation_parallax3_post_id_callback', array(__CLASS__, 'field_search'), 10, 3);
			add_filter('vc_autocomplete_wi_donation_parallax3_post_id2_callback', array(__CLASS__, 'field_search'), 10, 3);
		add_filter('vc_autocomplete_wi_donation_parallax3_post_id2_callback', array(__CLASS__, 'field_search'), 10, 3);
	}

	static function vc_map() {
		return [
			"name" => esc_html__("Parallax Style 3", 'lifeline-donation-pro'),
            "base" => self::$shortcode,
            ...
            "params" => array(
                array(
    				'type'          => 'attach_image',
    				'class'         => '',
    				'heading'       => esc_html__( 'Side Image', 'lifeline-donation-pro' ),
    				'param_name'    => 'side_image',
    				'description'   => esc_html__( 'Upload side image to show.', 'lifeline-donation-pro' ),
    			),
                ...
                array(
                    ...
                    "param_name" => "title",
                    "description" => esc_html__("Enter the title to show", 'lifeline-donation-pro')
                ),
                array(
                    "type" => "textarea",
                    "class" => "",
                    ...
                    "param_name" => "text",
                    "description" => esc_html__("Enter text to show", 'lifeline-donation-pro')
                ),
            array( 
    			'type'              => 'checkbox',
    			'class'             => '',
            ...
            array(
				'type'       => 'textfield',
				'heading'    => esc_html__( 'Button 2 Label', 'lifeline-donation-pro' ),
				'param_name' => 'btn_label2',
				'group'      => esc_html__( 'Button 2', 'lifeline-donation-pro' ),
