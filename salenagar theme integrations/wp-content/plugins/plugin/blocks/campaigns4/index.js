( function( wp ) {
	 ...
	 * @see https://wordpress.org/gutenberg/handbook/designers-developers/developers/block-api/#registering-a-block
	 */
	registerBlockType( 'lifeline-donation/campaigns4', {
		/**
		 * This is the display title for your block, which can be translated with `i18n` functions.
		 * The block inserter will show this name.
		 */
		title: __( 'Donation Campaigns 4', 'lifeline-donation' ),
		description: __( 'Campaigns style 4: you can show donation button by displaying different content and banners to attract donors', 'lifeline-donation' ),
		...
		edit: withSelect(function(select, props){
			...
			return [
					...
					el(
						'section',
						{className: 'wpcm-wrapper urgent-popup-list wp-block-lifeline-donation-campaigns4'},
						(posts) ? 
							el(
								...
								el(
									...
									el(
										'div', {className: 'wpcm-cause-style4'},
										el(
											'div', {className: 'wpcm-cause-style4-img'},
											el(
												'figure', {},
												el('img', {src: (media) ? ((media[0]) ? media[0].source_url : '') : ''})
											),
											el(
												'div', {className: 'wpcm-hover-btn'},
												el('a', {href:'#', className: 'wpcm-btn wpcm-btn-radius wpcm-btn-red'}, __('Donate Now', 'lifeline-donation'))
											),
											el(
												'div', {className: 'wpcm-cause-style4-contnt'},
												el('h2', {}, first(posts).title.rendered),
												el(
													'span', {className: 'wpcm-cause-meta'},
													el('i', {className: 'flaticon-place'}),
													'United States'
												),
												el(
													'span', {className: 'wpcm-cause-meta'},
													el('i', {className: 'flaticon-calendar'}),
													'Jul 25, 2019'
												),
												el('p', {}, 'Lorem ipsum dolor sit amet, consectur adipis cing elit. Vivamus in magnac tellus fringilla ele olor sit amet, consec ifend.'),
												el(
													'span', {},
