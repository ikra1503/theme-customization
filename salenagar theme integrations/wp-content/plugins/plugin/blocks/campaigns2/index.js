( function( wp ) {
	 ...
	 * @see https://wordpress.org/gutenberg/handbook/designers-developers/developers/block-api/#registering-a-block
	 */
	registerBlockType( 'lifeline-donation/campaigns2', {
		/**
		 * This is the display title for your block, which can be translated with `i18n` functions.
		 * The block inserter will show this name.
		 */
		title: __( 'Donation Campaigns 2', 'lifeline-donation' ),
		description: __( 'Campaigns style 2: you can show donation button by displaying different content and banners to attract donors', 'lifeline-donation' ),
		...
		edit: withSelect(function(select, props){
			...
			return [
					...
					el(
						'section',
						{className: 'wpcm-wrapper urgent-popup-list wp-block-lifeline-donation-campaigns2'},
						(posts) ? 
							el(
								'div', {className: 'wpcm-row'},
								el(
									'div', {className: 'wpcm-col-md-4'},
									el(
										'div', {className: 'wpcm-cause-style2'},
										el(
											'div', {className: 'cause-style2-iner'},
											el(
												'figure', {},
											...
											el(
												'div', {className: 'dontn-amnt-info'},
												el(
													'span', {},
													el('strong', {}, __('GOAL:', 'lifeline-donation')),
													'$90000'
												),
												el(
													'span', {},
													el('strong', {}, __('Raise:', 'lifeline-donation')),
													'$50000'
												)
											),
											el('a', {href: '#', className: 'wpcm-btn wpcm-btn-border'}, __('Donate Now', 'lifeline-donation'))
										)
									)
								)
							)	
