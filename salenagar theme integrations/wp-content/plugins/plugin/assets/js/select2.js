  ...
  !(function (d) {
    ...
    (o = function (a, b) {
      var c,
        ...
        e = d[0];
      return (
        (a = d[1]), e && ((e = f(e, b)), (c = j(e))), e ? (a = c && c.normalize ? c.normalize(a, h(b)) : f(a, b)) : ((a = f(a, b)), (d = k(a)), (e = d[0]), (a = d[1]), e && (c = j(e))), { f: e ? e + "!" + a : a, n: a, pr: e, p: c }
      );
    }),
      (p = {
        require: function (a) {
    ...
    a("select2/data/select", ["./base", "../utils", "jquery"], function (a, b, c) {
      ...
      return (
        ...
        (d.prototype.item = function (a) {
          ...
          if (a.is("option")) b = { id: a.val(), text: a.html(), disabled: a.prop("disabled"), selected: a.prop("selected"), title: a.prop("title") };
    ...
    a(
      ...
      function (a, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C) {
        function D() {
          this.reset();
        }
    ...
    a("select2/options", ["jquery", "./defaults", "./utils"], function (a, c, d) {
      ...
      return (
        (e.prototype.fromElement = function (b) {
          var c = ["select2"];
          null == this.options.multiple && (this.options.multiple = b.prop("multiple")),
            ...
            (window.console &&
              ...
              b.data("tags", !0)),
            b.data("ajaxUrl") &&
            (window.console && console.warn && console.warn("Select2: The `data-ajax-url` attribute has been changed to `data-ajax--url` and support for the old attribute will be removed in future versions of Select2."),
    ...
    a("select2/core", ["jquery", "./options", "./utils", "./keys"], function (a, b, c, d) {
      ...
      return (
        ...
        (e.prototype.data = function () {
          ...
          var a = [];
          return (
            this.dataAdpater.current(function (b) {
              a = b;
            }),
            a
          );
    ...
    b("jquery.select2"),
    (jQuery.fn.select2.amd = { define: a, require: b });
})();
