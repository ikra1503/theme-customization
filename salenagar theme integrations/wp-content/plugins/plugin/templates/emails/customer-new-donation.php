													...
													<table cellspacing="0" cellpadding="0" width="100%" style="background-color: #1aa0e6; border-radius: 3px; margin-top: 12px;">
														<tr>
															<td align="center" valign="middle" style="color:#FFFFFF; font-family: 'Barlow', sans-serif; font-size:14px; font-weight:bold; line-height:150%; padding-top:17px; padding-right:40px; padding-bottom:17px; padding-left:40px;">
																<a href="<?php echo esc_url($new_order->profile_url); ?>" target="_blank" style="color:#FFFFFF; text-decoration:none;"><?php printf(esc_html__('VIEW %s', 'lifeline-donation-pro'), $orders_label ); ?></a>
															</td>
														</tr>
													</table>
												</td>
								...
								<tr>
									<td align="top" valign="middle" width="75%">
										<table border="0" cellpadding="40" cellspacing="0" width="100%">
											<tr>
												<td align="left" valign="top">
													<span style="color: #1b5e82; font-size: 15px; font-family: 'Barlow', sans-serif;"><?php printf(esc_html__('Hi, %s', 'lifeline-donation-pro'), $customer->name) ?></span>
													<br/>
													<span style="color: #1aa0e6; font-size: 20px; font-family: 'Barlow', sans-serif; font-weight: 700; padding-top: 5px; display: block;"><?php printf( esc_html__('Thank you for the %s', 'lifeline-donation-pro'), $order_label ); ?></span>
												</td>
											</tr>
										</table>
									</td>
