	...
	<div class="block gray">
		...
		<div class="wpcm-container">
			...
			<div class="wpcm-row">
				...
				<div class="<?php echo sanitize_html_class( ( wpcm_get_settings()->get('archive_sidebar_layout') == 'left' || wpcm_get_settings()->get('archive_sidebar_layout') == 'right' ) ) ? 'wpcm-col-md-9' : 'wpcm-col-md-12'; ?> column">
