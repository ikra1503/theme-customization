 ...
 * @since 1.0.0
 */
class parallax4 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Parallax Style 4', 'lifeline-donation-pro' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wpcm-start-campaign' => 'background-color: {{VALUE}}',
                ],
                'conditions' => array(
                    'relation' => 'OR',
                    'terms'    => array(
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __( 'https://youtu.be/U6-vDpjthog', 'lifeline-donation-pro' ),
                'conditions' => array (
                    'relation' => 'OR',
                    'terms'    => array(
                        array(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} a.wpcm-btn, {{WRAPPER}} .elementor-button',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} a.wpcm-btn' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} a.wpcm-btn' => 'background: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} a.wpcm-btn:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} a.wpcm-btn:hover' => 'background: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        $file = get_theme_file_path( 'templates/elementor/parallax4.php' );

        if( file_exists($file)) {
            include $file;
        } else {
            include LIFELINE_DONATION_PATH . 'elementor/output/parallax4.php';
        }
