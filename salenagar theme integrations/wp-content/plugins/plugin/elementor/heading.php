...
class Heading extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Heading', 'lifeline-donation-pro' );
	}
	...
	protected function render() {
		...
		$file = get_theme_file_path( 'templates/elementor/heading.php' );

		if ( file_exists( $file ) ) {
			include $file;
		} else {
			include LIFELINE_DONATION_PATH . 'elementor/output/heading.php';
		}
	}
