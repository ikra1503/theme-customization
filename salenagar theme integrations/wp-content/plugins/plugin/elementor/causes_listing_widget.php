 ...
 * @since 1.0.0
 */
class Causes_Listing_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'wi_donation_causes_listing_widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Causes Listing Widget', 'lifeline-donation-pro' );
	}
	...
	protected function render() {
		...
		if ( $query->have_posts() ) {
			...
			$file = get_theme_file_path( 'templates/elementor/causes_listing_widget.php' );

			if ( file_exists( $file ) ) {
				include $file;
			} else {
				include LIFELINE_DONATION_PATH . 'elementor/output/causes_listing_widget.php';
			}
		}
		wp_reset_postdata();
	}
