 ...
 * @since 1.0.0
 */
class parallax3 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Parallax Style 3', 'lifeline-donation-pro' );
    }
    ...
    protected function render() {
        ...
        $file = get_theme_file_path( 'templates/elementor/parallax3.php' );

        if( file_exists($file)) {
            include $file;
        } else {
            include LIFELINE_DONATION_PATH . 'elementor/output/parallax3.php';
        }
