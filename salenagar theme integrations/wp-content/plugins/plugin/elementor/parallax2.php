 ...
 * @since 1.0.0
 */
class parallax2 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Parallax Style 2', 'lifeline-donation-pro' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wpcm-donation-style1' => 'background-color: {{VALUE}}',
                ],
                'conditions' => array(
                    'relation' => 'OR',
                    'terms'    => array(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __( 'Typography', 'lifeline-donation-pro' ),
                'scheme' => Typography::TYPOGRAPHY_1,
                'selector' => '{{WRAPPER}} span.description',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} span.description' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} span.description:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
    ...
    protected function render() {
        ...
        $file = get_theme_file_path( 'templates/elementor/parallax2.php' );

        if( file_exists($file)) {
            include $file;
        } else {
            include LIFELINE_DONATION_PATH . 'elementor/output/parallax2.php';
        }
