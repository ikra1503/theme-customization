 ...
 * @since 1.0.0
 */
class Causes extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Donation Causes', 'lifeline-donation-pro' );
    }
    ...
    protected function render() {
        ...
        $this->add_render_attribute('button', 'class', 'wpcm-btn elementor-button');
        ...
        if( $query->have_posts() ) {
            ...
            if( file_exists($file)) {
                ...
                include LIFELINE_DONATION_PATH . 'elementor/output/causes.php';
            }
        }
        wp_reset_postdata();
    }
