...
class DFWPTheme {
  ...
  public $slug="necromancers";

  function __construct() {
    
    $licenseKey=get_option("DFWPTheme_lic_Key","");
    $liceEmail=get_option( "DFWPTheme_lic_email","");
    ...
    if ( DFWPThemeActivationBase::CheckWPPlugin($licenseKey,$liceEmail,$this->licenseMessage,$this->responseObj, get_template_directory() . '/style.css' ) ){
      ...
      update_option("DFWPTheme_lic_Key","") || add_option("DFWPTheme_lic_Key","");
      ...
      function df_admin_notice__error() {
        ...
        $reg_url = admin_url( 'admin.php?page=necromancers' );

        echo '<div class="notice notice-warning is-dismissible notice--noregistered"><p>';
        printf(
          esc_html__( 'Thank you for your purchase! It is necessary to activate your license for using the theme. %1$s', 'necromancers' ),
          sprintf(
            '<a href="%s">%s</a>',
            $reg_url,
            esc_html__( 'Activate now', 'necromancers' )
          )
        );
        echo '</p></div>';
      }
      ...
      // Remove Demo Import
      function df_remove_demo_import_submenu() {
        remove_submenu_page( 'themes.php', 'one-click-demo-import' );
      }
      add_action( 'admin_menu', 'df_remove_demo_import_submenu', 999 );
  ...
  function action_activate_license(){
    ...
    update_option("DFWPTheme_lic_Key",$licenseKey) || add_option("DFWPTheme_lic_Key",$licenseKey);
    update_option("DFWPTheme_lic_email",$licenseEmail) || add_option("DFWPTheme_lic_email",$licenseEmail);
        ...
        <div class="welcome-panel welcome-panel--df">
          ...
          <div class="el-license-container">
            ...
            <div class="el-license-field">
              ...
              <?php $purchaseEmail = get_option( "DFWPTheme_lic_email", get_bloginfo( 'admin_email' )); ?>
