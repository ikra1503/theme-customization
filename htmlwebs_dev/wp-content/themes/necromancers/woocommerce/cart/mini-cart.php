			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<div class="product-body">
						...
						<?php $product_cats = wp_get_post_terms( $product_id, 'product_cat' ); ?>
						<ul class="product-cats list-unstyled">
							<?php foreach ( $product_cats as $key => $cat ) : ?>
								<li class="product-cats-item">
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'necromancers' ); ?></p>
